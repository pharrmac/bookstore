...
public class BookDaoJdbc implements BookDao {
    ...
    public Book findByBookId(long bookId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding book %s" + bookId, e);
        }
        return book;
    }
    ...
    public List<Book> findByCategoryId(long categoryId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding books by category id %s" + categoryId, e);
        }
        return books;
    }
    ...
    public List<Book> findRandomByCategoryId(long categoryId, int limit) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding books randomly by category id %s" + categoryId, e);
        }
        return books;
    }
    ...
    private Book readBook(ResultSet resultSet) throws SQLException {
        ...
        return new Book(bookId, categoryId, title, author, description, price, rating, isPublic, isFeatured);
    }
}
